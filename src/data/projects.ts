...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "apps",
    status: "experimental",
    description: "Le portail des expériences Blacklace : protocoles, parcours, archives et accès aux jeux du laboratoire.",
    url: "https://benoitlub.github.io/feuchlab/",
    emoji: "⚗️",
    actionLabel: "Entrer au Feuch Lab",
  },
  {
    id: "blacklace-pass",
    title: "Blacklace Pass",
    category: "games",
    status: "development",
    description: "Carte membre commune à Feuch Lab, 420 Dice et Blacklace Dice : achat unique prévu à 4,20 €. Activation et restauration des droits en préparation.",
    url: "https://benoitlub.github.io/feuchlab/?protocol=portal",
    emoji: "🎟️",
    actionLabel: "Découvrir le Pass",
  },
  {
    id: "blacklace-echo",
